...
const Header = ({ toggleTheme }) => {
  ...
  const [togggle, showMenu] = useState(false);
    ...
    <themeContext.Provider>
      <header className="header">
        <nav className="nav container">
          ...
          <div className={togggle ? "nav__menu show-menu" : "nav__menu"}>
            ...
            <i className="uil uil-times nav__close" onClick={() => showMenu(!togggle)}></i>
          </div>
          ...
          <div className="nav__toggle-container">
            ...
            {/* Apps Icon */}
            <div className="nav__toggle" onClick={() => showMenu(!togggle)}>
